...
declare namespace browser.webNavigation {
    ...
    interface WebNavigationOnCommittedDetails {
    ...
    interface _WebNavigationOnCommittedEvent<TCallback = (details: WebNavigationOnCommittedDetails) => void> {
        addListener(cb: TCallback, filters?: EventUrlFilters): void;
...
declare namespace browser.webRequest {
    ...
    interface WebRequestOnBeforeRequestDetails {
        /**
         * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
         * relate different events of the same request.
         */
    ...
    interface _WebRequestOnBeforeRequestEvent<TCallback = (details: WebRequestOnBeforeRequestDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
    ...
    interface WebRequestOnBeforeSendHeadersDetails {
        /**
         * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
         * relate different events of the same request.
         */
    ...
    interface _WebRequestOnBeforeSendHeadersEvent<TCallback = (details: WebRequestOnBeforeSendHeadersDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
    ...
    interface WebRequestOnCompletedDetails {
        /**
         * The ID of the request. Request IDs are unique within a browser session. As a result, they could be used to
         * relate different events of the same request.
         */
    ...
    interface _WebRequestOnCompletedEvent<TCallback = (details: WebRequestOnCompletedDetails) => void> {
...
declare namespace browser.tabs {
    ...
    interface TabsOnUpdatedEventChangeInfo {
    ...
    interface _TabsOnUpdatedEvent<TCallback = (tabId: number, changeInfo: TabsOnUpdatedEventChangeInfo, tab: Tab) => void> {
     ...
     */
    const onActivated: WebExtEvent<(activeInfo: onActivatedActiveInfo) => void>;
